 ...
 */
const CommandWithOptions_definition_1 = require("./command_with_options/CommandWithOptions.definition");
const CommandWithPositionals_definition_1 = require("./command_with_positionals/CommandWithPositionals.definition");
/**
...
const IssueDefinition = {
    ...
    type: "group",
    children: [CommandWithOptions_definition_1.CommandWithOptionsDefinition, CommandWithPositionals_definition_1.CommandWithPositionalsDefinition]
};
